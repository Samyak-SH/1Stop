import { StyleSheet, Text, View, TextInput, ScrollView, TouchableOpacity, Modal, ActivityIndicator, Image, KeyboardAvoidingView, Platform, Keyboard } from 'react-native'
